...
insert into fix (coordinates, fix_name, fix_type_id) values ('53°31''53"N 020°58''13"E', 'SY363', 3);
insert into fix (coordinates, fix_name, fix_type_id) values ('53°48''54"N 020°59''13"E', 'SY362', 3);
insert into fix (coordinates, fix_name, fix_type_id) values ('53°33''44"N 020°47''56"E', 'SY364', 3);
insert into fix (coordinates, fix_name, fix_type_id) values ('53°27''10"N 020°21''13"E', 'SY361', 3);
insert into fix (coordinates, fix_name, fix_type_id) values ('53°21''49"N 020°39''10"E', 'SY366', 3);
insert into fix (coordinates, fix_name, fix_type_id) values ('53°42''45"N 020°54''37"E', 'SY357', 3);

insert into fix (coordinates, fix_name, fix_type_id) values ('53°26''34"N 020°25''40"E', 'SY791', 4);
insert into fix (coordinates, fix_name, fix_type_id) values ('53°33''17"N 020°36''13"E', 'SY792', 4);
insert into fix (coordinates, fix_name, fix_type_id) values ('53°49''01"N 020°55''42"E', 'SY793', 4);
insert into fix (coordinates, fix_name, fix_type_id) values ('53°44''23"N 020°52''25"E', 'SY801', 4);
insert into fix (coordinates, fix_name, fix_type_id) values ('53°41''38"N 021°03''29"E', 'SY802', 4);

insert into fix (coordinates, fix_name, fix_type_id) values ('53°32''40"N 020°49''13"E', 'BRAVO',  5);
insert into fix (coordinates, fix_name, fix_type_id) values ('53°28''26"N 020°58''03"E', 'ECHO',   5);
insert into fix (coordinates, fix_name, fix_type_id) values ('53°30''07"N 020°53''55"E', 'WHISKEY',5);
insert into fix (coordinates, fix_name, fix_type_id) values ('53°25''13"N 021°07''05"E', 'ZULU',   5);
