...
public class SearchTool implements KeyListener, ActionListener {
    ...
    public SearchTool(Airspace airspace, MapPanel mapPanel) {
        ...
        //searchEngine = context.getBean("desiredEngine", io.github.morbidreich.ui.search.SearchEngine.class);
        searchEngine = new MyFirstSearchEngine();
        //searchEngine = new io.github.morbidreich.FixSearchEngine();
    }

    // set up io.github.morbidreich.ui.search.SearchTool structure
...
//
    ...
    public void keyReleased(KeyEvent e) {
        ...
        // clear searchPhrase JTextField, send empty io.github.morbidreich.ui.search.SearchResult object to mapPanel
