...
public class FallbackDataReader implements AirspaceReader {
    ...
    private static List<Polygon> getPolygons() {
        ...
        System.out.println("io.github.morbidreich.jpa.FallbackDataReader begin data read...");
        ...
        System.out.println("io.github.morbidreich.jpa.FallbackDataReader polygons read: " + polygonList.size());
        return polygonList;
    }
