...
public class Procedure implements Cloneable {
    //i need cloneable for io.github.morbidreich.SearchEngine - it clones object to
    //be able to modify isVisible field without modifying original io.github.morbidreich.Procedure
    @Id
