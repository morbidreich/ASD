...
public class FallbackDataReader implements AirspaceReader {
    ...
    private static List<Polygon> getPolygons() {
        ...
        System.out.println("io.github.morbidreich.FallbackDataReader begin data read...");
        ...
        System.out.println("io.github.morbidreich.FallbackDataReader polygons read: " + polygonList.size());
        return polygonList;
    }
