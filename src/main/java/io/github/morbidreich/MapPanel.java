    ...
    private class MousePanner implements MouseListener, MouseMotionListener {
        ...
        public void mousePressed(MouseEvent e) {
            ...
            if (SwingUtilities.isLeftMouseButton(e)) {
                ...
                if (!drawingRBL) {
                    // detect if clicked inside io.github.morbidreich.RBL label. If so then delete clicked io.github.morbidreich.RBL
                    // if not draw another io.github.morbidreich.RBL
