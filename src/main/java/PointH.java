...
public class PointH {
     ...
     * @param longitude
     */
    public PointH(Coordinates coords) {
        this(coords.getLatitude(), coords.getLongitude());
    }

    public PointH(double latitude, double longitude) {
     ...
     */
    public PointH(double northing, double easting, int foo) {
    ...
    public PointH(PointH a, PointH b, double fraction) {
     ...
     */
    public double distanceTo(PointH other) {
